				...
				<form id="updateUser" action="<?= base_url('user/update/' . $user['id_user']) ?>" method="post">
					<div class="card">
						<div class="card-body">
							...
							<input type="text" class="form-control" id="username" name="username" value="<?= esc($user['nama_user']) ?>" required />
							...
							<div class="row mt-1">
								<div class="col-md-6">
									...
									<input type="text" class="form-control" id="email" name="email" value="<?= esc($user['email']) ?>" required />
								</div>
								<div class="col-md-6">
									<!-- Inputan Tanggal Lahir -->
									<h5 class="card-title mt-2">Tanggal Lahir</h5>
									<input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="<?= esc($user['tgl_lahir']) ?>" required />
								</div>
							</div>
							...
							<div style="
                                    ...
                                    margin-top: 20px;
                                ">
								<a onclick="history.back()" type="button" class="btn btn-info">
									Cancel
								</a>
