...
<main class="content">
	<div class="container-fluid p-0">
		...
		<div class="row">
			<div class="col-12">
				<form id="postKematianMaternal" action="<?= base_url('kematian_maternal/create') ?>" method="post">
					<div class="card">
						<div class="card-body">
                            ...
                            <textarea class="form-control" id="penyebab_kematian" name="penyebab_kematian" cols="30" rows="3" placeholder="Masukkan Penyebab Kematian Maternal"></textarea>
                            <!-- Inputan Masa Kematian Maternal -->
                            <h5 class="card-title mt-2">Masa Kematian Maternal</h5>
                            <input type="text" class="form-control" id="masa_kematian" name="masa_kematian" placeholder="Masukkan Masa Kematian Maternal" required />
							<!-- Button Submit -->
							<div style="
                                    position: relative;
                                    text-align: right;
...
<script src="<?= base_url('js/kematian_maternal/create.js') ?>"></script>