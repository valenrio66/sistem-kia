...
$routes->get('/dashboard/keluarga_berencana/add', 'KeluargaBerencana::renderPageCreateKeluargaBerencana', ['filter' => 'auth']);
$routes->post('/keluarga_berencana/create', 'KeluargaBerencana::createKeluargaBerencana', ['filter' => 'auth']);
